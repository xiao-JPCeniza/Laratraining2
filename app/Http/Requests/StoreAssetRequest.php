...
class StoreAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
     ...
     return [
            ...
            'asset_tag' => 'nullable|string|max:255|unique:assets,asset_tag', // Optional but must be unique
            'name' => 'required|string|max:255|unique:assets,name', // Required, unique, max 255 characters
            'serial_number' => 'required|string|max:255|unique:assets,serial_number', // Required, unique, max 255 characters
